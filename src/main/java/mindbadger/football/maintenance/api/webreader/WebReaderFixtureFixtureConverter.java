...
public class WebReaderFixtureFixtureConverter {
    ...
    public List<Fixture> convertWebReaderFixturesToFixtures (List<WebReaderFixture> webReaderFixtures) throws ExternalServiceInvocationException {
    ...
    public void ensureSeasonDivisionTeamStructureExistsForWebFixture (WebReaderFixture webReaderFixture) throws ExternalServiceInvocationException {
    ...
    private void createSeasonDivisionTeamIfNotExists(SeasonDivision seasonDivision, String teamId) throws ExternalServiceInvocationException {
    ...
    private String createTeamIfNotExists(Integer webReaderTeamId, String teamName) throws ExternalServiceInvocationException {
    ...
    private SeasonDivision createSeasonDivisionIfNotExists(Integer season, Integer webReaderDivisionId) throws ExternalServiceInvocationException {
    ...
    private void createSeasonIfNotExists(Integer season) throws ExternalServiceInvocationException {
