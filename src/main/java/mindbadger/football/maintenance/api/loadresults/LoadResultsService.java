...
public class LoadResultsService {
    ...
    public void loadResultsForDate (String fixtureDate) throws JsonProcessingException, IOException {
...
//        saveFixtures(newFixtures, existingFixtures);
    ...
    public Fixture prepareWebReaderFixture (WebReaderFixture webReaderFixture) throws IOException {
