...
public class InitialiseSeasonService {
    ...
    public void initialiseSeason (String season) throws ExternalServiceInvocationException {
...
//        statisticsCalculationService.updateStatisticsForFixtures(fixtures);
    ...
    private Map<Integer, String> readFixturesForTeams (String season, Map<Integer, String> teams, Map<String, Fixture> fixtureMap, Map<String, SeasonDivisionTeam> seasonDivisionTeamMap, Map<String, SeasonDivision> seasonDivisionMap) throws ExternalServiceInvocationException {
    ...
    private Map<String, Fixture> getAllFixturesForSeason (String season) throws ExternalServiceInvocationException {
    ...
    private void processWebReaderFixture(@RequestParam("season") String season, Map<String, Fixture> fixtureMap, Map<String, SeasonDivisionTeam> seasonDivisionTeamMap, Map<String, SeasonDivision> seasonDivisionMap, WebReaderFixture webReaderFixture2) throws ExternalServiceInvocationException {
    ...
    private void createSeasonIfNotExists(String season) throws ExternalServiceInvocationException {
    ...
    private String getTeamIdForWebReaderTeamAndCreateIfNotExists (Integer webReaderTeamId, String teamName) throws ExternalServiceInvocationException {
